...
loops_file_path = "../output/loops_chr_all_8000.tsv"                   # path to loops.tsv file
bed_1_file_path = "../input/bed_files/H3K27ac.peak.homer.exBL.bed"       # Left histone mark/TF
bed_2_file_path = "../input/bed_files/H3K4me1.peak.homer.exBL.bed"     # Right histone mark/TF
out_file_path = "../output/merge_loops/loops_left_H3K27ac_right_H3K4me1_8000.bedpe"                               # path to output file
