...
cool_file_path="../../output/DE_merged_bio_rep_500000_normalized.cool"        # path to normalized .cool file
bedpe_file_path="../../output/loops_merged.bedpe"                             # path to loops .bedpe file
flank = 10_000_000                                                            # flanking distance around loops
...
plt.imshow(
    np.log2(pup_bedpe.loc[0, 'data']+1e-15),
    vmax = 0.2,
    vmin = -0.2,
    cmap='coolwarm',
    interpolation='none')
