...
loops_file_path="../output/1_loops_histone_marks_intersection_chromHMM_bidirectional/Promoters_Enhancers_bidirectional/loops_Promoters_Enhancers_{resolution}_bidirectional.bedpe"    

# path to output directory
out_path="../output/2_combine_multi_res_loops"    

# out file prefix
out_file_prefix="loops_merged_mutli_res_Promoters_Enhancers"
