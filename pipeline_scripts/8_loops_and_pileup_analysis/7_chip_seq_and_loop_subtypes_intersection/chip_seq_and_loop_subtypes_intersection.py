...
chip_seq_path = "../input/bed_files/DE_Ctrl_PRDM1.0.7rpm.bed"
 
# path to loops.tsv file
loops_file_path = "../input/MCAI70-R1-output/2_combine_multi_res_loops/loops_merged_mutli_res_Bivalent_Bivalent.tsv"   

# output path
out_path = "../output/chip_seq_and_loop_subtypes_intersection"     

# path to output files prefix
out_file_prefix = "chip_seq_and_loop_subtypes_intersection"        

call(["mkdir", "-p", out_path])

# extract beds
bed_1_df = pd.read_csv(chip_seq_path, sep="\t")
print(bed_1_df.shape)
print(bed_1_df)
print(bed_1_df.columns)
